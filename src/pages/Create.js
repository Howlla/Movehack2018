...
class Create extends Component {
  ...
  handleCreateNewProduct = () => {
    ...
    this.props.passageInstance.createProduct(this.state.name, this.state.description, this.state.latitude.toString(), this.state.longitude.toString(),this.state.latitude1.toString(),this.state.longitude1.toString(), certificationsArray, JSON.stringify(customDataObject), {from: this.props.web3Accounts[0], gas:1000000})
      .then((result) => {

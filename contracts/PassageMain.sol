...
contract PassageMain is PassageHelper {
    ...
    function createProduct(
      ...
      string _customJsonData
        ...
        product.destinationLatitude = _destinationLatitude;
        product.destinationLongitude = _destinationLongitude;
    ...
    function updateProduct(
      ...
      string _customJsonData
        ...
        if (keccak256(_latitude) == keccak256(product.destinationLatitude) && keccak256(_longitude) == keccak256(product.destinationLongitude)){
            product.completed = true;
            // Fire an event to announce the reaching to destination
            ProductRecieved(_productId, msg.sender);
        }
    }
